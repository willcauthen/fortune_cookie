...
Fortune.create({ quote: "your first volume of poetry will be published as soon as you finish it",
 author: "unknown"})

Fortune.create({ quote: "you will meet a beautiful tall blonde stranger and you will not say hello",
 author: "unknown"})

Fortune.create({ quote: "you will take a long trip and you will be very happy, though alone",
 author: "unknown"})

Fortune.create({ quote: "in order to understand yourself, you must first destroy yourself",
 author: "unknown"})
...
Fortune.create({ quote: "that's not a run in your stocking, it's a hand on your leg",
 author: "unknown"})

Fortune.create({ quote: "relax a little; one of your most celebrated nervous tics will be your undoing",
 author: "unknown"})

Fortune.create({ quote: "at times, your disinterestedness may seem insincere, to strangers",
 author: "unknown"})

Fortune.create({ quote: "please disregard previous cookie",
 author: "unknown"})

Fortune.create({ quote: "you are going to make a very lucky girl very sad one day",
 author: "unknown"})

Fortune.create({ quote: "you were alone before they left you",
 author: "unknown"})

Fortune.create({ quote: "do not hit send",
 author: "unknown"})

Fortune.create({ quote: "there's someone special out there for everyone. you'll never meet them, but they are there",
 author: "unknown"})

Fortune.create({ quote: "life is like a box of bullshit",
 author: "unknown"})

Fortune.create({ quote: "no one cares. seriously. look it up",
 author: "unknown"})
...
Fortune.create({ quote: "if you love something, it's totally your fault",
 author: "unknown"})
...
Fortune.create({ quote: "if you love someone, let them nap",
 author: "unknown"})

Fortune.create({ quote: "you miss 100% of the naps you don't take",
 author: "unknown"})
...
Fortune.create({ quote: "horoscope: don't get too excited",
 author: "unknown"})

Fortune.create({ quote: "you were wrong about yourself",
 author: "unknown"})

Fortune.create({ quote: "everything's depressing if you live long enough",
 author: "unknown"})

Fortune.create({ quote: "horoscope: she's lying",
 author: "unknown"})

Fortune.create({ quote: "with a little luck, you'll never fall in love again",
 author: "unknown"})

Fortune.create({ quote: "every day is take your drugs to work day",
 author: "unknown"})
...
Fortune.create({ quote: "the problem is you",
 author: "unknown"})

Fortune.create({ quote: "pain is everywhere and the world is terrifying",
 author: "unknown"})

Fortune.create({ quote: "from now on, every song is about you",
 author: "unknown"})
...
Fortune.create({ quote: "Pro Tip: do not get out of bed",
 author: "unknown"})
...
Fortune.create({ quote: "if you wait until your ready, you'll be waiting the rest of your life",
 author: "unknown"})

Fortune.create({ quote: "the past is a foreign country, and they do things differently there",
 author: "unknown"})

Fortune.create({ quote: "you will always admire what you do not understand",
 author: "unknown"})
...
Fortune.create({ quote: "when eating poison, always lick the plate",
 author: "unknown"})

Fortune.create({ quote: "good friends will come and go, but enemies accumulate",
 author: "unknown"})
